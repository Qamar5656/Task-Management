  ...
  return (
    <div className="h-full flex flex-col relative">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between gap-4">
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white mb-1 font-heading">{workspace.name}</h1>
      ...
      <motion.div 
        ...
        className="flex-1 bg-slate-900/50 border border-slate-800 rounded-3xl p-8 flex flex-col"
      >
        <div className="flex items-center justify-between border-b border-slate-800 pb-4 mb-6">
          <h2 className="text-xl font-semibold text-white font-heading">Projects</h2>
          <Button 
            variant="primary" 
        ...
        {isProjectsLoading ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center py-12">
            ...
            <p className="text-slate-400 mb-6">No projects created yet in this workspace.</p>
            <Button 
              variant="secondary" 
              onClick={() => setIsCreateModalOpen(true)}
            ...
            {projects.map((project, index) => (
              ...
              >
                <Link to={`/projects/${project.id}`} className="block h-full">
                  <div className="group relative bg-[#1E293B]/40 backdrop-blur-md border border-white/5 rounded-2xl p-6 transition-all duration-300 hover:border-indigo-500/30 hover:shadow-[0_0_30px_rgba(99,102,241,0.1)] hover:-translate-y-1 h-full flex flex-col">
